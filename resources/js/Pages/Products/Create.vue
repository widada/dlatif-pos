  ...
  <AppLayout title="Tambah Produk">
    ...
    <div class="form-page">
      <div class="form-header">
        ...
        <p>Isi data produk sesuai informasi di kemasan</p>
      </div>
      ...
      <form @submit.prevent="submit" class="product-form">
        ...
        <div class="form-section">
          ...
          <div class="form-grid">
            <div class="form-group full">
              ...
              <input id="name" v-model="form.name" type="text" placeholder="Contoh: Maybelline Fit Me Foundation" :class="{ error: form.errors.name }" />
          ...
          <div class="form-grid three">
            <div class="form-group">
              ...
              <div class="input-prefix">
                <span>Rp</span>
                <input id="cost_price" v-model.number="form.cost_price" type="number" min="0" placeholder="0" :class="{ error: form.errors.cost_price }" />
              </div>
            ...
            <div class="form-group">
              ...
              <div class="input-prefix">
                <span>Rp</span>
                <input id="price_offline" v-model.number="form.price_offline" type="number" min="0" placeholder="0" :class="{ error: form.errors.price_offline }" />
              </div>
            ...
            <div class="form-group">
              ...
              <div class="input-prefix">
                <span>Rp</span>
                <input id="price_shopee" v-model.number="form.price_shopee" type="number" min="0" placeholder="0" :class="{ error: form.errors.price_shopee }" />
              </div>
        ...
        <div class="form-section">
          ...
          <div class="form-grid">
            <div class="form-group">
              ...
              <input id="stock" v-model.number="form.stock" type="number" min="0" placeholder="0" :class="{ error: form.errors.stock }" />
            ...
            <div class="form-group">
              ...
              <input id="min_stock" v-model.number="form.min_stock" type="number" min="0" placeholder="5" :class="{ error: form.errors.min_stock }" />
        ...
        <div class="form-actions">
          ...
          <button type="submit" class="btn-primary" :disabled="form.processing">
            <svg v-if="form.processing" class="spinner" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M12 2v4m0 12v4m10-10h-4M6 12H2m15.07-5.07l-2.83 2.83M9.76 14.24l-2.83 2.83m11.14 0l-2.83-2.83M9.76 9.76L6.93 6.93" /></svg>
